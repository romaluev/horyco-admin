...
This document provides a complete understanding of the Horyco Admin Panel: architecture, navigation, user roles, and how sections connect. Use this as your starting point before diving into specific sections.
...
## Introduction to Horyco

**Horyco** is a **white-label B2B2C platform** for restaurant management with multi-tenant architecture.
