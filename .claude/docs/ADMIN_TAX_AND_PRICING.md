...
This document explains how tax and service charge configuration works in Horyco, including tenant-level vs branch-level settings, order type filtering, and automatic calculation.
