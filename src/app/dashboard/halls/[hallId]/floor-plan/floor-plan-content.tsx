...
import { useHallById } from '@/entities/hall'
import { useTableList, useDeleteTable, useUpdateTablePosition, type ITable } from '@/entities/table'
import { CreateTableDialog } from '@/features/table-form'
import { UpdateTableDialog } from '@/features/table-form/ui/update-table-dialog'
import { SessionStatusCard, CloseSessionDialog } from '@/features/table-session'
